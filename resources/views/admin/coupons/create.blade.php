...
@section('title', 'Create Coupon - AUA Collection')
...
<div class="mb-4">
    ...
    <h4 class="font-serif fw-bold text-uppercase letter-spacing-1">Create Discount Coupon</h4>
</div>
    ...
    <form action="{{ route('admin.coupons.store') }}" method="POST">
        ...
        <div class="row mb-3">
            <div class="col-md-6">
                ...
                <input type="text" name="code" id="code" class="form-control @error('code') is-invalid @enderror" value="{{ old('code') }}" placeholder="e.g. SUMMER26" style="text-transform: uppercase;" required>
                @error('code')
        ...
        <div class="row mb-3">
            <div class="col-md-6">
                ...
                <input type="number" step="0.01" name="min_spend" id="min_spend" class="form-control @error('min_spend') is-invalid @enderror" value="{{ old('min_spend') }}">
                @error('min_spend')
                    <div class="invalid-feedback">{{ $message }}</div>
                @enderror
            </div>
            <div class="col-md-6">
                ...
                <input type="number" step="0.01" name="max_discount" id="max_discount" class="form-control @error('max_discount') is-invalid @enderror" value="{{ old('max_discount') }}">
        ...
        <div class="row">
            <div class="col-md-6 mb-2">
                <button type="submit" class="btn btn-luxury-gold w-100 py-3 fw-bold">CREATE COUPON</button>
            </div>
            <div class="col-md-6">
